// Site-wide details used on the public website, privacy and terms pages.
// ⚠ Check these before launch (legal name, address, contact email, prices).
export const SITE = {
  name: 'Nassau Academy',
  ...
  instagramUrl: 'https://www.instagram.com/nassau_curacao/',
